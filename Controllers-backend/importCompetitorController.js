...
async function import_Competitor(req, res) {
    ...
    try {
        ...
        let insert_data = await insert_Competitor(data);
        return res.send({ status: "success", data: data });

    } catch (error) {
        console.error("Error in import_Competitor: ", error);
...
async function read_excel(path) {
    try {
        ...
        throw new Error("Error reading Excel file"); // Throw an error to be handled in import_Competitor
    }
}


//insert Competitor
async function insert_Competitor(data) {
    try {
        ...
        throw new Error("Error inserting data"); // Throw an error to be handled in import_Competitor
    }
}
module.exports = {
    import_Competitor,
