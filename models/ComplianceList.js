...
module.exports = (sequelize, DataTypes) => {
  class ComplianceList extends Model {
    ...
    static associate(models) {
      ComplianceList.belongsTo(models.MapStoreComplianceList, {
          foreignKey: 'map_storecompliance_list_id',
          as: 'mapStoreComplianceList', // ตั้งชื่อ alias เพื่อให้ใช้งานได้ง่ายในภายหลัง
      });
      ComplianceList.belongsTo(models.Compliance, {
          foreignKey: 'compliance_id',
          as: 'compliance',
      });
    }
  };
  ComplianceList.init({   // ตั้งชื่อตารางในฐานข้อมูล และกำหนดฟิลด์
    compliance_id: {
    ...
    sequelize,
    modelName: 'ComplianceList',
    tableName: 'tb_compliancelist',
    timestamps: true,
    scopes: {
      withPassword: {
